...
// Could possibly just put some of the facts in the html rendering rather than/in tandem with a conditional 
//alert box. 
function init(data) {
...
if  (todayPositive > 10) {
    ...
    `${data[0].state} remains ${differencePositive.toFixed(2)}% above the overall positive percentage average of ${compPositive}%.`,
    `warning`, 
   { 
    buttons: {
    mask: "I'll Wear A Mask",
